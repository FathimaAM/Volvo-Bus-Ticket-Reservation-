...
<center>
  ...
  <table class="table" style="width: 500px;color: black">
    ...
    <td><a class="btn btn-success" href="user_cancelticket.php?bid=<?php echo $row['booking_child_id'] ?>&bmid=<?php echo $row['booking_master_id'] ?>&bsid=<?php echo $row['bus_id'] ?>&seatnum=<?php echo $row['no_of_seat'] ?>">Cancel Ticket</a></td> 
