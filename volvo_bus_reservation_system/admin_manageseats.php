...
if (isset($_POST['mseat'])) {
 ...
 if (sizeof($res1)>0) {
	...
	echo$q="insert into seats values(null,'$seat','$bid','pending','$seat')";
	insert($q);
	alert('  Successfully');
...
<center>
	...
	<?php }else{ ?>
		<table class="table" style="width: 500px;color: white">
			...
			<tr>
				<td align="center" colspan="2"><input type="submit" name="mseat" value="submit" class="btn btn-success"></td>
			</tr>
		</table>
	<?php } ?>
	</form>
