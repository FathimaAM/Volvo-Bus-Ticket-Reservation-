...
if (isset($_POST['amount'])) {
	extract($_POST);
	echo$q="insert into fares values(null,'$sid','$eid','$pamo','$pamo','$rid')";
	insert($q);
	alert('  Successfully');
...
if (isset($_POST['update'])) {
	extract($_POST);
    $q="update fares set starting_stop_id='$sid',ending_stop_id='$eid',  amount_per_seat='$pamo',pass_amount='$pamo' where fare_id='$uid'";
	update($q);
	alert('  Successfully');
  return redirect("admin_managefares.php?rid=$rid");
