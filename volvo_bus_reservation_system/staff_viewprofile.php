<?php include 'staff_header.php';
  ...
  extract($_GET);
   ...
   $q="update staff set first_name='$f', last_name='$l', house_name='$hn', place='$pl', pincode='$pc',phone='$ph',email='$e' where staff_id='$profid'  ";

    update($q);
    // $q="update login set username='$u' where login_id='$logid'";
    // update($q);
    return redirect("staff_viewprofile.php");
   }
?>
<!-- Carousel Start -->
...
<table class="table" style="width: 500px;color: white">
    <tr>
        ...
        <tr>
            ...
            <td><input type="text" value="<?php echo $row['house_name']?> " name="hn" id=""></td>
</tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" value="<?php echo $row['pincode']?> " name="pc" id=""></td>
</tr>
        <tr>

            <th align="right">phone :</th>
            <td><input type="text" value="<?php echo $row['phone']?> " name="ph" id=""></td>
</tr>
...
<table class="table" style="width: 500px;color: white">
    ...
    <tr>
              ...
              <td align="center" colspan="2"><a class="btn btn-success" href="?profid=<?php echo $row['staff_id']?>&logid=<?php echo $row['login_id']?>">Update profile</a></td>
