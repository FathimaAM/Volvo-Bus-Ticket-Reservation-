...
if (isset($_POST['bus'])) {
	...
	if (sizeof($re)>0) {
	 ...
	 $q="insert into bus values(null,'$breg','$driver','$phone','$year','$model','$route')";
	insert($q);
	alert("success..");
...
<center>
	...
	<?php }else{ ?>
		<table class="table" style="width: 500px;color: white">
			...
			<tr>
				<td align="center" colspan="2"><input type="submit" name="bus" value="submit" class="btn btn-success"></td>
			</tr>
		</table>
	<?php } ?>
	</form>
